...
--Second way;  fetch next row only = limit
...
select kitap_isim,yazar_isim from kitaplar left join
yazarlar on kitaplar.kitap_id=yazarlar.kitap_id;


-- SORU2: Tüm yazar_isim'lerini ve yazarların kitap_isim'lerini listeleyiniz.
select yazar_isim,kitap_isim from yazarlar left join
kitaplar on kitaplar.kitap_id=yazarlar.kitap_id;
