...
select * from kursiyerler;--Tüm sütunlardaki verileri listeledik
...
delete from kursiyerler;--Şart belirtmiyorsak bu şekilde tabloda ki bütün verileri sileriz.


--Kursiyerler tablosunuda silelim
...
=====================================================================*/
/*
Yeni sutun için = add column
Mevcut sutunu silmek için = drop column
Sutun isimini değiştirmek için = rename column
Tablo isimini değiştirmek için = rename  
*/
...
alter table arabalar drop vites;
