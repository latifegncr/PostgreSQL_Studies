...
INSERT INTO musteriler (id, isim, maas) VALUES (1000, 'Kelabalık', 100000);
...
--SORU3: isim'i buyuk harf kucuk harf gözetmeksizin 'A' 
--ile baslayan tum bilgileri listeleyiniz
--'gözetmeksizin' dediği zaman "ilike" kullamıyoruz.
...
select * from musteriler where isim like 'F____%'

--SORU11: isim'in ikinci harfi 'a' olup,
--4.harfi 'm' olan en az 4 harfli tum bilgilerini listeleyiniz.
select * from musteriler where isim like '_a_m_%'

--SORU12: isim'i icerisinde 'i' olmayan tum bilgileri listeleyiniz.
select * from musteriler where isim not like '%i%'
--NOte: İçerisinde i olmayan dediği için 'not like' kullandık.
...
-- SORU1 : ilk harfi 'h', son harfi 't' olup, 2. harfi 'a' veya 'i' olan 
--3 harfli kelimelerin tum bilgilerini listeleyiniz.
...
select * from exercises where kelime ~* 'h[ai]t' 
--Burda büyük harf küçük harf gözetmeksizin dediği için, RegexpLike(~) işaretinin
-- yanına *(asteriks) işareti koyulur.

-- SORU3 : ilk harfi 'h', son harfi 't' olup, 2.harfi 'a' ile
--'k' arasinda olan 3 harfli kelimelerin  tum bilgilerini listeleyiniz
