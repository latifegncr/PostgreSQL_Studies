...
--Child tablodaki veri silinmeden Parent tablodaki veri silinmeye çalışıldıgında PgAdmin Eror vermez
...
select avg(fiyat) ortalama_fiyat from arac;
...
select count(marka) as arac_sayisi from arac;
--2YOL 
...
update malzemeler set malzeme_isim = () where musteri_isim = 'Ali Can';
